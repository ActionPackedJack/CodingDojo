...
namespace Creepypet.Models
{
    public class Eldritchcreature
    {
        ...
        public Eldritchcreature feed()
        {
            ...
            if (Evolves())
            {
                return new Eldritchcreature(energy, happiness, fullness + (5 * meals), 0, true, true, "The creature has grown quite large and gobbles up your remaining food supplies.  You will need to find larger sources of food...");
            }
